...
//            }
    ...
    private InputStream trustedCertificatesInputStream() {
        ...
        try {
            inputStream = context.getResources().openRawResource(R.raw.zhy_server);
        } catch (Exception e) {
            inputStream = null;
        }
        return inputStream;
...
//                .inputStream();
    ...
    private InputStream keyCertificatesInputStream() {
        InputStream inputStream;
        try {
            inputStream = context.getResources().openRawResource(R.raw.zhy_client);
        } catch (Exception e) {
            inputStream = null;
        }
        return inputStream;
     ...
     */
    //server
    private TrustManager[] trustManagerForCertificates(InputStream in)
    ...
    //client
    private KeyManager[] keyManagerForCertificates(InputStream inputStream)
            throws GeneralSecurityException {
